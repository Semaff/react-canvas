...
const ShareLinkModal = ({ showModal, setShowModal }) => {
        ...
        <div className="modal-bg">
            <div className="modal">
                <div className="modal__header">
                    <h2 className="modal__title">Поделиться с другом: </h2>
                </div>
                <div className="modal__body">
                    <p className="modal__text">{href}</p>
                </div>
                <div className="modal__footer">
                    <button className='modal__btn' onClick={() => setShowModal(false)}>Закрыть</button>
                </div>
            </div>
        </div>
    )
...
const ShareLink = () => {
    ...
    return (
        <>
            ...
            <div className="share-link" onClick={() => setShowModal(true)}>
                <svg viewBox="0 0 195.085 195.085" width={20} height={20}>
                    <g>
